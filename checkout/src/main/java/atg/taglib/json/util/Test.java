...
/**
 * Test class. This file is not formally a member of the atg.taglib.json.util library.
...
public class Test {
    ...
    public static void main(String args[]) {
        ...
        String s;
        try {
            j = XML.toJSONObject("<![CDATA[This is a collection of test patterns and examples for atg.taglib.json.util.]]>");
